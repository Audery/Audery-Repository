...
namespace BrnMall.Framework.Theme
{
    /// <summary>
    /// 主题路径提供者视图引擎
    /// </summary>
    public abstract class ThemeVirtualPathProviderViewEngine : VirtualPathProviderViewEngine
    {
        ...
        /// PC店铺前台视图位置格式
        /// </summary>
        private readonly string[] _storewebviewlocationformats = new string[2] { "~/themes/{2}/views/{0}.cshtml", "~/views/shared/{0}.cshtml" };

        /// <summary>
        /// 移动前台视图位置格式
        /// </summary>
        private readonly string[] _mobileviewlocationformats = new string[2] { "~/mobile/views/{1}/{0}.cshtml", "~/mobile/views/shared/{0}.cshtml" };

        /// <summary>
        /// App前台视图位置格式
        /// </summary>
        private readonly string[] _appviewlocationformats = new string[2] { "~/app/views/{1}/{0}.cshtml", "~/app/views/shared/{0}.cshtml" };

        /// <summary>
        /// PC店铺后台视图位置格式
        /// </summary>
        private readonly string[] _storeadminviewlocationformats = new string[2] { "~/admin_store/views/{1}/{0}.cshtml", "~/admin_store/views/shared/{0}.cshtml" };

        /// <summary>
        /// PC商城后台视图位置格式
        /// </summary>
        private readonly string[] _malladminviewlocationformats = new string[2] { "~/admin_mall/views/{1}/{0}.cshtml", "~/admin_mall/views/shared/{0}.cshtml" };
