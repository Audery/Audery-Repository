...
namespace BrnMall.Framework.Pager
{
    /// <summary>
    /// 商城前台分页类
    /// </summary>
    public class WebPager : BasePager
    {
        ...
        /// <returns></returns>
        public BasePager RouteName(string name)
        {
            _routename = name;
            return this;
        }
        ...
        /// <returns></returns>
        public BasePager PageParamName(string name)
        {
            _pageparamname = name;
            return this;
        }
        ...
        /// <returns></returns>
        public BasePager RouteValues(string key, string value)
        {
