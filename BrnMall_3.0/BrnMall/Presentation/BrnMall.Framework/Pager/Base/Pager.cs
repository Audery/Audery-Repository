...
namespace BrnMall.Framework.Pager.Base
{
    /// <summary>
    /// 分页基类
    /// </summary>
    public abstract class BasePager
    {
        ...
        public BasePager(PageModel pageModel)
        {
        ...
        /// <returns></returns>
        public BasePager ShowSummary(bool value)
        {
            _showsummary = value;
            return this;
        }
        ...
        /// <param name="value">value</param>
        /// <returns></returns>
        public BasePager ShowItems(bool value)
        {
            _showitems = value;
            return this;
        }
        ...
        /// <param name="value">value</param>
        /// <returns></returns>
        public BasePager ItemCount(int count)
        {
            _itemcount = count;
            return this;
        }
        ...
        /// <param name="value">value</param>
        /// <returns></returns>
        public BasePager ShowFirst(bool value)
        {
            _showfirst = value;
            return this;
        }
        ...
        /// <param name="value">value</param>
        /// <returns></returns>
        public BasePager ShowPre(bool value)
        {
            _showpre = value;
            return this;
        }
        ...
        /// <param name="value">value</param>
        /// <returns></returns>
        public BasePager ShowNext(bool value)
        {
            _shownext = value;
            return this;
        }
        ...
        /// <param name="value">value</param>
        /// <returns></returns>
        public BasePager ShowLast(bool value)
        {
            _showlast = value;
            return this;
        }
        ...
        /// <param name="value">value</param>
        /// <returns></returns>
        public BasePager ShowPageSize(bool value)
        {
            _showpagesize = value;
            return this;
        }
        ...
        /// <param name="value">value</param>
        /// <returns></returns>
        public BasePager ShowGoPage(bool value)
        {
            _showgopage = value;
            return this;
        }
