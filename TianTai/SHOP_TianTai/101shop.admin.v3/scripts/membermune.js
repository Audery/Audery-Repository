...
outlookbar.additem('个人资料',t,'individualinfo/memberinfo_show.aspx');
outlookbar.additem("修改密码",t,"individualinfo/rework_password.aspx");
outlookbar.additem("修改资料",t,"individualinfo/memberinfo_edit.aspx");
//短消息中心
t=outlookbar.addtitle('短消息中心','短消息中心',1);
outlookbar.additem('写短消息',t,'circlereview/shortmessage_create.aspx');
outlookbar.additem('收件箱',t,'circlereview/memberinfo_show.aspx?type=1');
outlookbar.additem("发件箱",t,"circlereview/rework_password.aspx?type=2");
outlookbar.additem("草稿箱",t,"circlereview/memberinfo_edit.aspx?type=0");
outlookbar.additem("废件箱",t,"circlereview/memberinfo_edit.aspx?type=3");
