<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="product_report.aspx.cs"
    Inherits="_101shop.admin.v3.admin.product_manager.product_report" %>
    ...
    <div class="page_main">
        <asp:GridView ID="tablist" CssClass="datatable" runat="server" AutoGenerateColumns="False"
            ...
            <Columns>
                ...
                <asp:TemplateField HeaderText="规格（含转换比、件装）">
                    <ItemTemplate>
                ...
                <asp:TemplateField HeaderText="批号数量">
                    <ItemTemplate>
                        <%#SOSOshop.BLL.Report.DrugTestingReport.GetCount((int)Eval("product_Id"))%>
                    </ItemTemplate>
                    <ItemStyle CssClass="unclick" />
                </asp:TemplateField>
                <asp:TemplateField HeaderText="下载次数">
                    <ItemTemplate>
                        <%#SOSOshop.BLL.Report.DrugTestingReport.GetDowCount((int)Eval("product_Id"))%>
                    </ItemTemplate>
                    <ItemStyle CssClass="unclick" />
                </asp:TemplateField>
                <asp:TemplateField HeaderText="操作">
                    <ItemTemplate>
                        <a href="product_reportAdd.aspx?id=<%#Eval("product_Id")%>">药检管理</a>
                    </ItemTemplate>
                    <ItemStyle CssClass="unclick" />
                </asp:TemplateField>
            </Columns>
