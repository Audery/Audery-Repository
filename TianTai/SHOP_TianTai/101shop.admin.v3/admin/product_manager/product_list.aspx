<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="product_list.aspx.cs" Inherits="_101shop.admin.v3.admin.product_manager.product_list" %>
...
<body>
    <form id="form1" runat="server" action="/admin/product_manager/product_list.aspx">
    <!--内容搜索-->
    <div class="page_toolbar" id="pagetoolbar">
        ...
        <div class="page_info">
            ...
            价格：<select name="Price" style="width: 50px">
                ...
                <%--    <option value="7" <%if(Request["Price"]=="7"){%> selected<%} %>>基药价</option>--%>
            ...
            状态：<select name="bShelves" style="width: 50px">
                ...
                <option value="4" <%if(Request["bShelves"]=="4"){%> selected<%} %>>待审核</option>
            </select>
            ...
            点击量：<select name="bDjl" title="点击量">
                <option value="0">全部</option>
                <option value="1" <%if(Request["bDjl"]=="1"){%> selected<%} %>>升序</option>
                <option value="2" <%if(Request["bDjl"]=="2"){%> selected<%} %>>降序</option>
            </select>
            <br />
            ...
            <%--  卖点：<select name="bMaid">
                <option value="0">全部</option>
                <option value="1" <%if(Request["bMaid"]=="1"){%> selected<%} %>>批发有</option>
                <option value="2" <%if(Request["bMaid"]=="2"){%> selected<%} %>>批发无</option>
                <option value="3" <%if(Request["bMaid"]=="3"){%> selected<%} %>>OTC有</option>
                <option value="4" <%if(Request["bMaid"]=="4"){%> selected<%} %>>OTC无</option>
            </select>          --%>
            库存区间:
            ...
            <%if (isSeeUpAll)
              { %>采购员：<asp:DropDownList ID="cgy" runat="server" DataTextField="cgy" DataValueField="cgy"
                  Width="75">
              </asp:DropDownList>
            <%} %>
