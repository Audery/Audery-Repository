<%@ Page Language="C#" MasterPageFile="~/admin/admin_page.master" AutoEventWireup="true" CodeBehind="MemberIntegralDetail.aspx.cs" Inherits="_101shop.admin.v3.member.MemberIntegralDetail" Title="" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="pagetitle" runat="server">会员积分明细
</asp:Content>
...
<input type="button" class="inputbutton" value="查询" onclick="Search('SearchDiv', 'truename,phone,DropDownList1,CompanyName,CheckBox1,Editer', 'MemberIntegralDetail.aspx')" style="width:65px;height:23px" />
</div>
</asp:Content>
