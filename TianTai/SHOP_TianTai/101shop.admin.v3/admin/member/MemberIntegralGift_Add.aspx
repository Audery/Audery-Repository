<%@ Page Language="C#" MasterPageFile="~/admin/admin_page.master" AutoEventWireup="true"
    CodeBehind="MemberIntegralGift_Add.aspx.cs" Inherits="_101shop.admin.v3.member.MemberIntegralGift_Add"
    Title="" %>
...
<asp:Content ID="Content4" ContentPlaceHolderID="workspace" runat="server">
    ...
    <table id="formtbl" runat="server" class="form_table_input" border="0" width="100%"
        ...
        <tr>
            ...
            <td>
                <asp:TextBox ID="txtName" runat="server" tip="请填写礼品名称" validatetype="isnull" warning="必填"
                    error="该项为必填项"></asp:TextBox>
            </td>
            <td>
        ...
        <tr>
            ...
            <td>
                <asp:TextBox ID="txtDetail" runat="server" TextMode="MultiLine" tip="请填写兑换说明" validatetype="isnull"
                    warning="必填" error="该项为必填项" Width="420px" Height="180px"></asp:TextBox>
            </td>
            <td>
        ...
        <tr>
            ...
            <td>
                <asp:TextBox ID="txtIntegral" runat="server" tip="请填写兑换积分" validatetype="isnumber"
                    warning="必填" error="该项为必填项"></asp:TextBox>
            </td>
            <td>
        ...
        <tr>
            ...
            <td>
                <asp:TextBox ID="txtNumber" runat="server" tip="请填写可兑换数量" validatetype="isnumber"
                    warning="必填" error="该项为必填项"></asp:TextBox>
            </td>
            <td>
        ...
        <tr id="Tr0" runat="server">
            ...
            <td>
                <asp:CheckBoxList ID="ckbMember_Class" runat="server" RepeatDirection="Horizontal"
                    RepeatLayout="Flow">
