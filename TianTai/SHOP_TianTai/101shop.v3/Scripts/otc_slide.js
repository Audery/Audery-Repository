...
///幻灯片加载
function  hdpjz(){
    //2015.1.4 sjj 调整为支持动态幻灯片
    var xpic = 0;
    $(".td_f").each(function () {//alert($(this).html());
        if ($(this).html().trim().length > 10) {
            xpic += 1;
        }
    });
    $(".num1").css({
        "padding": "8px 0 8px " + (588 - xpic * 30) + "px"
    });
    //结束
    //alert(xpic);
    var st = new SlideTrans("idContainer2", "idSlider2", xpic, { Vertical: false });
