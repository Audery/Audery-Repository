...
{
    public partial class DrugBaseZyc : DevComponents.DotNetBar.Office2007Form
    {
        private int _iden;
        private string _idenName;
        public DrugBaseZyc(int pHeight, int iden, string idenName)
        {
        ...
        {
            AddDrugBaseZyc adb = new AddDrugBaseZyc(_idenName);
            adb.ShowDialog();
        }
        ...
        private void Bind()
        {
            ...
            li = bll.GetDrugsBaseApplyZycList(out recordCount, out pageCount, PageSize, PageIndex, _idenName, fields.ToArray(), values.ToArray(), AddDrugBase.key);
            if (li != null)
            {
        ...
        private void 修改ToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            {
                DrugsBaseApplyZyc model = li[CurrentRowIndex];
                AddDrugBaseZyc ad = new AddDrugBaseZyc(_idenName);
                ad.model = model;
                ad.ShowDialog();
            }
        }
        ...
        private void 删除ToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            if (!"已审核".Equals(row.Cells["Column13"].Value))
            {
                ...
                {
                    DrugsBaseSoapClient bll = new DrugsBaseSoapClient();
                    bll.DeleteDrugsBaseApplyZyc(row.Cells["id"].Value.ToString(), AddDrugBase.key);
                    Bind();
                }
            }
        }
        ...
        private void toolStripMenuItem1_Click(object sender, EventArgs e)
        {
            ...
            bll.ModifyDrugsBaseApplyZyc(model, AddDrugBase.key);
            Bind();
        }
