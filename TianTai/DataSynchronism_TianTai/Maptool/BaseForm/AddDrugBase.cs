...
{
    public partial class AddDrugBase : DevComponents.DotNetBar.Office2007Form
    {
        ...
        public AddDrugBase(string idenName)
        {
            InitializeComponent();
        ...
        private void buttonX2_Click(object sender, EventArgs e)
        {
            ...
            DataSet ds = db.GetDrugsbaseAllList(20, 1, fileds.ToArray(),values.ToArray(),true, key);
