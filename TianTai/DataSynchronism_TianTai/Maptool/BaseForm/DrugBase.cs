...
{
    public partial class DrugBase : DevComponents.DotNetBar.Office2007Form
    {
        private int _iden;
        private string _idenName;
        public DrugBase(int pHeight, int iden, string idenName)
        {
        ...
        {
            AddDrugBase adb = new AddDrugBase(_idenName);
            adb.ShowDialog();
        }
